  ...
  render() {
    return (
      ...
      >
        ...
        >
          <div style={{ fontSize: 40, margin: '10px 0 10px ' }}>
            Quem somos?
          </div>
          <div style={{ fontSize: 24, width: 'inherit', textIndent: '1em' }}>
            Um aluno do último período em bacharelado em sistemas da informação
            no instituto federal catarinense (IFC), tentando finalizar o curso e
          ...
          <div style={{ fontSize: 24, width: 'inherit', textIndent: '1em' }}>
            ...
            divertido temos alguns joguinhos para deixar tudo mais leve e
            casual.
          </div>
          <div
            style={{
